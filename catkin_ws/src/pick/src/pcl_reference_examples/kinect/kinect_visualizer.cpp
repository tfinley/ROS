...
//edited to use the PCL Visualizer
...
main(int argc, char** argv)
{
    ...
    {
        kinectGrabber = new OpenNIGrabber("A00366A08328134A"); //added "", OpenNIGrabber::OpenNI_Default_Mode, OpenNIGrabber::OpenNI_Default_Mode 
        if (kinectGrabber == 0)
            return false;
