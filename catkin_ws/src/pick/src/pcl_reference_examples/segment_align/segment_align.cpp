...
the data will be segmented around the pick point. Then ICP will attempt to align the source (lifting eye) to the segmented cloud.

Call: ./segment_align [source].pcd [target].pcd
