	...
	while not rospy.is_shutdown():
		...
		if glbwork1in[0] == 1 or glbwork1in[0] ==1.01: 
			...
			if glbwork1in[0]>0 and glbwork1in[0]<1.1:
				rospy.sleep(40*random.random()+120)
...
if __name__ == '__main__':
	rospy.init_node('worker2node')
	wk1in = rospy.Publisher('work2in',Float32MultiArray)
	wk1out = rospy.Publisher('work2out',Float32MultiArray)
	
	rospy.Subscriber('work2inpkt',Float32MultiArray,wk1incase)
	rospy.Subscriber('work2outpkt',Int16,wk1outcase)
