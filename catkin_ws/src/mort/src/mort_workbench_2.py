...
class Workbench():
	...
	def __init__(self):
		...
		self.supply = 2
		self.finished = 1
		rospy.Subscriber("mort/Workbench2/supplyGiven", Int16, self.supplyWorkbench)
		rospy.Subscriber("mort/Workbench2/finishedTaken", Int16, self.pickupFished)
		self.supply_pub = rospy.Publisher('mort/workbench2/supplyNeed', Int16)
		self.finished_pub = rospy.Publisher('mort/workbench2/finished', Int16)
	...
	def statusUpdate(self):
		rospy.loginfo('Workbench 2 Status Update')		
...
def main():
	rospy.init_node('mort_workbench_2')
	worker = Workbench()
