...
(cl:defmethod cl:initialize-instance :after ((m <Button-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Button-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pick-srv:<Button-request> is deprecated: use pick-srv:Button-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Button-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Button-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pick-srv:<Button-response> is deprecated: use pick-srv:Button-response instead.")))
