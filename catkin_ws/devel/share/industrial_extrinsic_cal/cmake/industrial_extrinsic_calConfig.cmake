...
if("TRUE" STREQUAL "TRUE")
  set(industrial_extrinsic_cal_SOURCE_PREFIX /home/taylor/src/ros/catkin_ws/src/industrial_calibration/industrial_extrinsic_cal)
  set(industrial_extrinsic_cal_DEVEL_PREFIX /home/taylor/src/ros/catkin_ws/devel)
  ...
  set(industrial_extrinsic_cal_INSTALL_PREFIX /home/taylor/src/ros/catkin_ws/install)
...
if(NOT "/home/taylor/src/ros/catkin_ws/src/industrial_calibration/industrial_extrinsic_cal/include" STREQUAL "")
  set(industrial_extrinsic_cal_INCLUDE_DIRS "")
  set(_include_dirs "/home/taylor/src/ros/catkin_ws/src/industrial_calibration/industrial_extrinsic_cal/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'industrial_extrinsic_cal' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'clewis <clewis@swri.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'industrial_extrinsic_cal' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/taylor/src/ros/catkin_ws/src/industrial_calibration/industrial_extrinsic_cal/${idir}'.  Ask the maintainer 'clewis <clewis@swri.org>' to fix it.")
    endif()
...
set(depends "roscpp;std_msgs;rosconsole;std_srvs;roslib")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${industrial_extrinsic_cal_dep}_FOUND)
      find_package(${industrial_extrinsic_cal_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${industrial_extrinsic_cal_dep} REQUIRED ${depend_list})
  endif()
